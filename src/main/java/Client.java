...
public class Client {
    ...
    public boolean run(String[] args) throws Exception {
        // Read YARNConfiguration and intitialize YARNClient
        ...
        // Connect to ResourceManager and request for new application ID
        System.out.println("Requesting ResourceManager for a new Application");
        YarnClientApplication app = yarnClient.createApplication();

        // Define ContainerLaunchContext for ApplicationMaster
        ...
        //Set up resource requirements for ApplicationMaster (memory and cores)
